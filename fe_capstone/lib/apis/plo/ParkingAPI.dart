...
class ParkingAPI{
  ...
  static Future<ParkingInformationModel> getParkingInformation(String token) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        ParkingInformationModel parkingInfo = ParkingInformationModel.fromJson(data);
        return parkingInfo;
      } else {
  ...
  static Future<List<RatingModel>> getRatingList(String token) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final List<RatingModel> ratings = data.map((json) => RatingModel.fromJson(json)).toList();
        return ratings;
      } else {
